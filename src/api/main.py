"""Legal Compliance Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Legal compliance agent that monitors regulatory changes, maps compliance requirements to business processes, tracks compliance status, generates audit evidence, and manages regulatory filings.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
